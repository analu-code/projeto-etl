...
from validator import PlanilhaAnuncios 
...
def validar_dados(df):
     ...
     for index, row in df.iterrows():
         try:
             ...
             # Valida os dados usando o modelo PlanilhaAnuncios
             planilha_validada = PlanilhaAnuncios(**dados)
...
def main():
     ...
     uploaded_file = st.file_uploader("Escolha um arquivo CSV", type="csv", key="upload validation")
